          ...
          >
            ...
            <div className="relative bg-surface rounded-2xl p-8 border border-border shadow-2xl font-mono text-sm">
              ...
              <div className="space-y-2">
                ...
                <p className="ps-4 text-tertiary">agency: <span className="text-primary">"MP Web Solutions"</span>,</p>
                <p className="ps-4 text-tertiary">experience: <span className="text-primary">"8+ years"</span>,</p>
                <p className="ps-4 text-tertiary">stack: [<span className="text-primary">"Next.js", "React", "Node"</span>],</p>
                <p className="ps-4 text-tertiary">focus: <span className="text-primary">"Conversion Optimization"</span></p>
